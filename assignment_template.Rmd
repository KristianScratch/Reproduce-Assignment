...
They had very thorough explanations of the code, what they aimed to do in eahc chunk. They introduced each novel function clearly; explaning the objective ans sometimes justifying choices (such as why they used pdf over other image saving formats). They also make it clear when they are calling on certain folders and where data is being saved to, which makes it easier to follow the overall flow.
